...
# Base paths (derived from repo root; override via env var if running from another layout)
import os

_ENV_ROOT = os.environ.get("JCCE_ROOT")
BASE_PATH = Path(_ENV_ROOT) if _ENV_ROOT else _find_repo_root()
