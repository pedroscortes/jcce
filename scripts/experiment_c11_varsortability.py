...
def main():
    ...
    parser.add_argument("--graph-types", nargs="+", default=["erdos_renyi", "chain", "scale_free"])
    ...
    print("VARSORTABILITY CHECK (C.11)")
    print("=" * 70)
    ...
    for r in results:
        print(
            f"{r['graph_type']:<16} {r['noise_scale']:>6.1f} "
    ...
    if high_varsort:
        ...
        print("Recommendation: Use noise_scale >= 0.5 or report both raw + standardized results.")
    else:
        print("OK: No conditions have varsortability > 0.9.")
