...
class TestBootstrapStabilityModule:
    ...
    def test_bootstrap_function_signature(self):
        ...
        expected = {'X', 'Y', 'hyperparams', 'processor_type', 'B', 'max_iter',
                    'A_init', 'edge_threshold', 'stability_threshold', 'seed',
                    'task', 'verbose'}
...
class TestHardThresholdAdjacency:
    ...
    def test_zeros_below_threshold(self):
        ...
        A = np.array([[0.0, 0.5, 0.1],
                       [0.2, 0.0, 0.8],
                       [0.05, 0.4, 0.0]], dtype=np.float32)
    ...
    def test_default_threshold(self):
        ...
        import inspect
        from jcce.utils.metrics import hard_threshold_adjacency, EDGE_THRESHOLD_DEFAULT
...
class TestC9StructureMetrics:
    ...
    def test_generate_classification_data_returns_A_true(self):
        ...
        X, Y, A_true = generate_classification_data(
            n_vars=5, n_samples=50, expected_degree=2.0,
...
class TestAIPWValidation:
    ...
    def test_generate_synthetic_ate_data(self):
        ...
        X, T, Y, true_ate = generate_synthetic_ate_data(
            n=200, p=5, true_ate=0.5, seed=42
        )
